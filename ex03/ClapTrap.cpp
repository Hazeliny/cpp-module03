...
/*   Updated: 2024/11/14 14:07:07 by linyao           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target) {
    if (this->_hitPoints < 1 && this->_energyPoints < 1)
        ...
        std::cout << "\033[31mClapTrap " << this->_name << " cannot attack " << target << " because he's run out of hit points and is dead\033[0m" << std::endl;
    else {
        this->_energyPoints--;
